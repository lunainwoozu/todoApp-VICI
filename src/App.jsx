...
function App() {
  ...
  const { badges, isBadgeModalOpen, setIsBadgeModalOpen } = useBadges(todos);
  ...
  return (
    <div className="h-screen min-w-[375px] flex flex-col items-center">
      ...
      <div className="w-full flex-grow overflow-y-auto bg-white rounded-t-xl">
        {activeTab === 'todos' &&
      ...
      {/* 배지 획득 모달 조건부 렌더링 */}
      {isBadgeModalOpen && <BadgeModal setIsBadgeModalOpen={setIsBadgeModalOpen} />}
    </div>
  );
};
